(() => {
    ...
    (() => {
        ...
        const btnProducts = document.querySelector(".products-btn");
        const wrappBg = document.querySelector(".page");
        if (menuBurger) menuBurger.addEventListener("click", (function(e) {
            ...
            if (btnProducts) btnProducts.classList.toggle("_opacity");
            if (wrappBg) if (menuBody.classList.contains("_menu-active") || btnProducts.classList.contains("_active")) wrappBg.classList.add("_after"); else wrappBg.classList.toggle("_after");
            if (btnProducts) btnProducts.classList.remove("_active");
        }));
        if (btnProducts) btnProducts.addEventListener("click", (function(e) {
            btnProducts.classList.toggle("_active");
            if (menuBody) menuBody.classList.remove("_menu-active");
            if (menuBurger) menuBurger.classList.remove("_icon-active");
            if (wrappBg) if (menuBody.classList.contains("_menu-active") || btnProducts.classList.contains("_active")) wrappBg.classList.add("_after"); else wrappBg.classList.remove("_after");
        }));
        const elNodes = document.querySelectorAll(".swiper-slide__block-description");
        elNodes.forEach((el => {
            el.addEventListener("click", (() => {
                el.classList.toggle("_description-active");
            }));
        }));
        function addClassAfterTime(className, timeInMilliseconds) {
            const element = document.querySelector(".fix-widget");
            setTimeout((() => {
                element.classList.add("_fix-active");
            }), 3e3);
        }
        addClassAfterTime();
